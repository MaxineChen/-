...
class ArticleList{
	...
	ArticleList(int pageNum){
		...
		try{
			  ...
			  ResultSet rs=stmt.executeQuery("SELECT * FROM commentary LIMIT "+begin+" , " + end+ " order by aid desc;");
			  int i=0;
			  while(rs.next()) {
    ...
    <body id="list-Page-Body">
        ...
        <div class="picture" style="background-image:url(<%out.print(backgroundImage);%>);">
            <div class="article-title">
                ...
                <p id="article-title-title" style="margin-left: 170px;">专栏 · 文章</p>
                <hr width="70%">
        ...
        <div><a href="commentaryPage.jsp?page=<%out.print(pageNum+1);%>">更多></a></div>
    </body>
    <script>
